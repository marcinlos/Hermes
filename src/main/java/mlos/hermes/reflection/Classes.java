...
public class Classes {
    ...
    /**
     * Returns an {@linkplain Iterable} collection of all the superclasses
     * of a given class, in order from the most derived ({@code clazz}) to
     * the {@code Object}.
     *  
     * @param clazz class whose superclasses are to be enumerated
    ...
    /**
     * Returns an {@linkplain Iterable} collection of all the ancestor types
     * of a given class. Both superclases and implemented interfaces are 
     * included.
     * <p>
     * The order and other characteristics of how the ancestor types are 
     * enumerated are as specified by the {@linkplain AncestorsIterator}'s
     * doc.
     * 
     * @param clazz class whose ancestor types are to be enumerated
